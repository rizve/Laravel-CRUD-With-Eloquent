        ...
        <div class="row">
            <div class="col-md-12 col-md-offset">
                <div class="panel panel-default">
                    <div class=" text-center" style="font-size: 18px;margin: 10px"><b>List Of Product Brand</b></div>
                    <hr>
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="my-dataTables">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center" style="background-color: #6f5e68; color: #fff;"> Product Name</th>
                                        <th class="text-center" style="background-color: #6f5e68; color: #fff;"> Action</th>                                                
                                    </tr>
                                </thead>
                                <tbody>
                                    @forelse($showProduct as $showProduct)
                                        <tr class="odd grade">
                                            <td class="text-center">{{$showProduct->id}}</td>
                                            
                                            <td class="text-center" value = "{{$showProduct->brand_id}}">{{$showProduct->brand->brand_name}}</td>
                                            <td class="text-center">{{$showProduct->product_name}}</td>
                                            <td class="text-center">
                                            <a href="{{route('product.edit',$showProduct->id)}}">Edit</a>  ||                                         
                                            <a href="{{route('product.get.destroy', $showProduct)}}" style="color:red">Delete </a>
                                            </td>
